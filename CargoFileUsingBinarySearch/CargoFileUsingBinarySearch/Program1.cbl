       ...
       program-id. Program1 as "CargoFileUsingBinarySearch.Program1".

       Environment division.
       Input-Output section.
       File-control.    Select shipData assign to 'E:\COBOL Stuff\CargoFileUsingBinarySearch\CargoFileUsingBinarySearch\CargosProducts.txt'
                           organization is line sequential. 
                        Select Outputfile assign to 'E:\COBOL Stuff\CargoFileUsingBinarySearch\CargoFileUsingBinarySearch\FinalReport.txt'
                        organization is line sequential.
      ...
      *Here redefines let you say : DataContainer will be putted inside ProductTable, so you call Datacontainer when using ProductTable
       01 ProductTable redefines DataContainer.
         05 arrayTable occurs 8 times ascending key WS-prodname indexed by A.
