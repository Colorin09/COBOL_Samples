       ...
       Program-id.
       Program1 as "CargosFile.Program1".

       Environment division.
       Input-Output section.
       File-control.    Select shipData assign to 'E:\COBOL Stuff\CargosFile\CargosFile\CargosProducts.txt'
                           organization is line sequential.
                        Select Outputfile assign to 'E:\COBOL Stuff\CargosFile\CargosFile\FinalReport.txt'
                        organization is line sequential.
       ...
       write Print-Rec.
           ...
           perform varying x
             ...
             until x > 8
               ...
               If shipProduct is equal WS-prodName(x)
                   Compute FinalPriceContainer = prodUnits * WS-prodCost(x)
